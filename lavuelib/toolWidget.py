...
_centeringformclass, _centeringbaseclass = uic.loadUiType(
    os.path.join(os.path.dirname(os.path.abspath(__file__)),
                 "ui", "CenteringToolWidget.ui"))
...
class CenteringToolWidget(ToolBaseWidget):
    """ line-cut tool widget
    """
    ...
    def __init__(self, parent=None):
        ...
        #: (:class:`Ui_CenteringToolWidget') ui_toolwidget object from qtdesigner
        self.__ui = _centeringformclass()
        self.__ui.setupUi(self)
